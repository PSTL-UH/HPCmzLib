...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string msms_pipeline_analysisDataset_derivation::getgeneration_no() const
        {
            return this->generation_noField;
        }

        void msms_pipeline_analysisDataset_derivation::setgeneration_no(const std::string &value)
        {
