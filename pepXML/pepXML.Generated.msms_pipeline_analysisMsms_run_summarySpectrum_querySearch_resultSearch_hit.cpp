...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::getpeptide() const
        {
            return this->peptideField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::setpeptide(const std::string &value)
        {
            this->peptideField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::getpeptide_prev_aa() const
        {
            return this->peptide_prev_aaField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::setpeptide_prev_aa(const std::string &value)
        {
            this->peptide_prev_aaField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::getpeptide_next_aa() const
        {
            return this->peptide_next_aaField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::setpeptide_next_aa(const std::string &value)
        {
            this->peptide_next_aaField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::getprotein() const
        {
            return this->proteinField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::setprotein(const std::string &value)
        {
        ...
        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::getnum_matched_ions() const
        {
            return this->num_matched_ionsField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::setnum_matched_ions(const std::string &value)
        {
            this->num_matched_ionsField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::gettot_num_ions() const
        {
            return this->tot_num_ionsField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::settot_num_ions(const std::string &value)
        {
        ...
        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::getmassdiff() const
        {
            return this->massdiffField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::setmassdiff(const std::string &value)
        {
            this->massdiffField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::getnum_tol_term() const
        {
            return this->num_tol_termField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::setnum_tol_term(const std::string &value)
        {
            this->num_tol_termField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::getnum_missed_cleavages() const
        {
            return this->num_missed_cleavagesField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::setnum_missed_cleavages(const std::string &value)
        {
            this->num_missed_cleavagesField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::getnum_matched_peptides() const
        {
            return this->num_matched_peptidesField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::setnum_matched_peptides(const std::string &value)
        {
        ...
        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::getprotein_descr() const
        {
            return this->protein_descrField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::setprotein_descr(const std::string &value)
        {
            this->protein_descrField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::getcalc_pI() const
        {
            return this->calc_pIField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hit::setcalc_pI(const std::string &value)
        {
