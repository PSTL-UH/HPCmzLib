...
namespace pepXML {
    namespace Generated {
        ...
        std::wstring msms_pipeline_analysisMsms_run_summarySearch_summary::getbase_name() const {
            return this->base_nameField;
        }

        void msms_pipeline_analysisMsms_run_summarySearch_summary::setbase_name(const std::wstring &value) {
        ...
        std::wstring msms_pipeline_analysisMsms_run_summarySearch_summary::getsearch_engine_version() const {
            return this->search_engine_versionField;
        }

        void msms_pipeline_analysisMsms_run_summarySearch_summary::setsearch_engine_version(const std::wstring &value) {
        ...
        std::wstring msms_pipeline_analysisMsms_run_summarySearch_summary::getout_data_type() const {
            return this->out_data_typeField;
        }

        void msms_pipeline_analysisMsms_run_summarySearch_summary::setout_data_type(const std::wstring &value) {
            this->out_data_typeField = value;
        }

        std::wstring msms_pipeline_analysisMsms_run_summarySearch_summary::getout_data() const {
            return this->out_dataField;
        }

        void msms_pipeline_analysisMsms_run_summarySearch_summary::setout_data(const std::wstring &value) {
