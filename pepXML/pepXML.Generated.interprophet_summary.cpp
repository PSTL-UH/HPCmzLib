...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string interprophet_summary::getversion() const
        {
            return this->versionField;
        }

        void interprophet_summary::setversion(const std::string &value)
        {
            this->versionField = value;
        }

        std::string interprophet_summary::getoptions() const
        {
            return this->optionsField;
        }

        void interprophet_summary::setoptions(const std::string &value)
        {
