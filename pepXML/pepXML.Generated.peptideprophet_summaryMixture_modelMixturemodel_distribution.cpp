...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string peptideprophet_summaryMixture_modelMixturemodel_distribution::getname() const
        {
            return this->nameField;
        }

        void peptideprophet_summaryMixture_modelMixturemodel_distribution::setname(const std::string &value)
        {
