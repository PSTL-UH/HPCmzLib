...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string msms_pipeline_analysisMsms_run_summarySpectrum_query::getspectrum() const
        {
            return this->spectrumField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_query::setspectrum(const std::string &value)
        {
            this->spectrumField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_query::getspectrumNativeID() const
        {
            return this->spectrumNativeIDField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_query::setspectrumNativeID(const std::string &value)
        {
        ...
        std::string msms_pipeline_analysisMsms_run_summarySpectrum_query::getassumed_charge() const
        {
            return this->assumed_chargeField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_query::setassumed_charge(const std::string &value)
        {
            this->assumed_chargeField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_query::getsearch_specification() const
        {
            return this->search_specificationField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_query::setsearch_specification(const std::string &value)
        {
