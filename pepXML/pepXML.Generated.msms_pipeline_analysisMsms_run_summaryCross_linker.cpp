...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string msms_pipeline_analysisMsms_run_summaryCross_linker::getidentifier() const
        {
            return this->identifierField;
        }

        void msms_pipeline_analysisMsms_run_summaryCross_linker::setidentifier(const std::string &value)
        {
        ...
        std::string msms_pipeline_analysisMsms_run_summaryCross_linker::getlink_sites() const
        {
            return this->link_sitesField;
        }

        void msms_pipeline_analysisMsms_run_summaryCross_linker::setlink_sites(const std::string &value)
        {
