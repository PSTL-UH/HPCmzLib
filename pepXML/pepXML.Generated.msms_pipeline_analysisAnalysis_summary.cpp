...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string msms_pipeline_analysisAnalysis_summary::getanalysis() const
        {
            return this->analysisField;
        }

        void msms_pipeline_analysisAnalysis_summary::setanalysis(const std::string &value)
        {
            this->analysisField = value;
        }

        std::string msms_pipeline_analysisAnalysis_summary::getversion() const
        {
            return this->versionField;
        }

        void msms_pipeline_analysisAnalysis_summary::setversion(const std::string &value)
        {
