...
namespace pepXML {
    namespace Generated {
        ...
        std::wstring ptmprophet_result::getptm() const {
            return this->ptmField;
        }

        void ptmprophet_result::setptm(const std::wstring &value) {
            this->ptmField = value;
        }

        std::wstring ptmprophet_result::getptm_peptide() const {
            return this->ptm_peptideField;
        }

        void ptmprophet_result::setptm_peptide(const std::wstring &value) {
