...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string peptideprophet_summaryMixture_model::getprecursor_ion_charge() const
        {
            return this->precursor_ion_chargeField;
        }

        void peptideprophet_summaryMixture_model::setprecursor_ion_charge(const std::string &value)
        {
            this->precursor_ion_chargeField = value;
        }

        std::string peptideprophet_summaryMixture_model::getcomments() const
        {
            return this->commentsField;
        }

        void peptideprophet_summaryMixture_model::setcomments(const std::string &value)
        {
        ...
        std::string peptideprophet_summaryMixture_model::gettot_num_spectra() const
        {
            return this->tot_num_spectraField;
        }

        void peptideprophet_summaryMixture_model::settot_num_spectra(const std::string &value)
        {
            this->tot_num_spectraField = value;
        }

        std::string peptideprophet_summaryMixture_model::getnum_iterations() const
        {
            return this->num_iterationsField;
        }

        void peptideprophet_summaryMixture_model::setnum_iterations(const std::string &value)
        {
