...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string peptideprophet_summary::getversion() const
        {
            return this->versionField;
        }

        void peptideprophet_summary::setversion(const std::string &value)
        {
            this->versionField = value;
        }

        std::string peptideprophet_summary::getauthor() const
        {
            return this->authorField;
        }

        void peptideprophet_summary::setauthor(const std::string &value)
        {
        ...
        std::string peptideprophet_summary::getoptions() const
        {
            return this->optionsField;
        }

        void peptideprophet_summary::setoptions(const std::string &value)
        {
