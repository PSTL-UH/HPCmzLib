...
namespace pepXML {
    namespace Generated {
        ...
        std::wstring msms_pipeline_analysisMsms_run_summary::getbase_name() const {
            return this->base_nameField;
        }

        void msms_pipeline_analysisMsms_run_summary::setbase_name(const std::wstring &value) {
            this->base_nameField = value;
        }

        std::wstring msms_pipeline_analysisMsms_run_summary::getraw_data_type() const {
            return this->raw_data_typeField;
        }

        void msms_pipeline_analysisMsms_run_summary::setraw_data_type(const std::wstring &value) {
            this->raw_data_typeField = value;
        }

        std::wstring msms_pipeline_analysisMsms_run_summary::getraw_data() const {
            return this->raw_dataField;
        }

        void msms_pipeline_analysisMsms_run_summary::setraw_data(const std::wstring &value) {
            this->raw_dataField = value;
        }

        std::wstring msms_pipeline_analysisMsms_run_summary::getmsManufacturer() const {
            return this->msManufacturerField;
        }

        void msms_pipeline_analysisMsms_run_summary::setmsManufacturer(const std::wstring &value) {
            this->msManufacturerField = value;
        }

        std::wstring msms_pipeline_analysisMsms_run_summary::getmsModel() const {
            return this->msModelField;
        }

        void msms_pipeline_analysisMsms_run_summary::setmsModel(const std::wstring &value) {
            this->msModelField = value;
        }

        std::wstring msms_pipeline_analysisMsms_run_summary::getmsIonization() const {
            return this->msIonizationField;
        }

        void msms_pipeline_analysisMsms_run_summary::setmsIonization(const std::wstring &value) {
            this->msIonizationField = value;
        }

        std::wstring msms_pipeline_analysisMsms_run_summary::getmsMassAnalyzer() const {
            return this->msMassAnalyzerField;
        }

        void msms_pipeline_analysisMsms_run_summary::setmsMassAnalyzer(const std::wstring &value) {
            this->msMassAnalyzerField = value;
        }

        std::wstring msms_pipeline_analysisMsms_run_summary::getmsDetector() const {
            return this->msDetectorField;
        }

        void msms_pipeline_analysisMsms_run_summary::setmsDetector(const std::wstring &value) {
