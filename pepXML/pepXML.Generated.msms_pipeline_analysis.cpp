...
namespace pepXML {
    namespace Generated {
        ...
        std::wstring msms_pipeline_analysis::getname() const {
            return this->nameField;
        }

        void msms_pipeline_analysis::setname(const std::wstring &value) {
        ...
        std::wstring msms_pipeline_analysis::getsummary_xml() const {
            return this->summary_xmlField;
        }

        void msms_pipeline_analysis::setsummary_xml(const std::wstring &value) {
