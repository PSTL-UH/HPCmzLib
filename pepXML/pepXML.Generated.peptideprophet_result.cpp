...
namespace pepXML {
    namespace Generated {
        ...
        std::wstring peptideprophet_result::getall_ntt_prob() const {
            return this->all_ntt_probField;
        }

        void peptideprophet_result::setall_ntt_prob(const std::wstring &value) {
            this->all_ntt_probField = value;
        }

        std::wstring peptideprophet_result::getanalysis() const {
            return this->analysisField;
        }

        void peptideprophet_result::setanalysis(const std::wstring &value) {
