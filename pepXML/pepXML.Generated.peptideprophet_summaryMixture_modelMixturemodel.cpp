...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string peptideprophet_summaryMixture_modelMixturemodel::getname() const
        {
            return this->nameField;
        }

        void peptideprophet_summaryMixture_modelMixturemodel::setname(const std::string &value)
        {
