...
//ORIGINAL LINE: [System.Xml.Serialization.XmlAttributeAttribute()] public string is_heavy
            std::string getis_heavy() const;
            void setis_heavy(const std::string &value);
        };
    }
}
