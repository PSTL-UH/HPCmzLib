...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlinkLinked_peptide::getpeptide() const
        {
            return this->peptideField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlinkLinked_peptide::setpeptide(const std::string &value)
        {
            this->peptideField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlinkLinked_peptide::getpeptide_prev_aa() const
        {
            return this->peptide_prev_aaField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlinkLinked_peptide::setpeptide_prev_aa(const std::string &value)
        {
            this->peptide_prev_aaField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlinkLinked_peptide::getpeptide_next_aa() const
        {
            return this->peptide_next_aaField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlinkLinked_peptide::setpeptide_next_aa(const std::string &value)
        {
            this->peptide_next_aaField = value;
        }

        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlinkLinked_peptide::getprotein() const
        {
            return this->proteinField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlinkLinked_peptide::setprotein(const std::string &value)
        {
        ...
        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlinkLinked_peptide::getdesignation() const
        {
            return this->designationField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlinkLinked_peptide::setdesignation(const std::string &value)
        {
