...
namespace pepXML {
    namespace Generated {
        ...
        std::wstring ptmprophet_summary::getversion() const {
            return this->versionField;
        }

        void ptmprophet_summary::setversion(const std::wstring &value) {
            this->versionField = value;
        }

        std::wstring ptmprophet_summary::getoptions() const {
            return this->optionsField;
        }

        void ptmprophet_summary::setoptions(const std::wstring &value) {
