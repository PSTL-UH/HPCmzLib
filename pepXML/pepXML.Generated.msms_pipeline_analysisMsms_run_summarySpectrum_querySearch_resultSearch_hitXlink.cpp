...
namespace pepXML
{
    namespace Generated
    {
        ...
        std::string msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlink::getidentifier() const
        {
            return this->identifierField;
        }

        void msms_pipeline_analysisMsms_run_summarySpectrum_querySearch_resultSearch_hitXlink::setidentifier(const std::string &value)
        {
