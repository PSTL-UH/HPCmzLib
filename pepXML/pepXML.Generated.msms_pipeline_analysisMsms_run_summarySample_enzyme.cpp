...
namespace pepXML {
    namespace Generated {
        ...
        std::wstring msms_pipeline_analysisMsms_run_summarySample_enzyme::getname() const {
            return this->nameField;
        }

        void msms_pipeline_analysisMsms_run_summarySample_enzyme::setname(const std::wstring &value) {
            this->nameField = value;
        }

        std::wstring msms_pipeline_analysisMsms_run_summarySample_enzyme::getdescription() const {
            return this->descriptionField;
        }

        void msms_pipeline_analysisMsms_run_summarySample_enzyme::setdescription(const std::wstring &value) {
