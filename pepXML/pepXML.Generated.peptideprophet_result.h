...
//ORIGINAL LINE: [System.Xml.Serialization.XmlAttributeAttribute()] public string all_ntt_prob
            std::string getall_ntt_prob() const;
            void setall_ntt_prob(const std::string &value);
