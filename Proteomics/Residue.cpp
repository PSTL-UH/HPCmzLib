...
std::vector<Residue*> const Residue::ResiduesByLetter;
    ...
    Residue::StaticConstructor::StaticConstructor() {
        ResiduesDictionary = std::unordered_map<std::string, Residue*> {
            {"Alanine", new Residue("Alanine", L'A', "Ala",ChemicalFormula::ParseFormula("C3H5NO"), ModificationSites::A)}, {
            {"Asparagine", new Residue("Asparagine", L'N', "Asn",ChemicalFormula::ParseFormula("C4H6N2O2"), ModificationSites::N)}, {
            {"Cysteine", new Residue("Cysteine", L'C', "Cys",ChemicalFormula::ParseFormula("C3H5NOS"), ModificationSites::C)}, {
            {"Glutamine", new Residue("Glutamine", L'Q', "Gln",ChemicalFormula::ParseFormula("C5H8N2O2"), ModificationSites::Q)}, {
            {"Histidine", new Residue("Histidine", L'H', "His",ChemicalFormula::ParseFormula("C6H7N3O"), ModificationSites::H)}, {
            {"Leucine", new Residue("Leucine", L'L', "Leu",ChemicalFormula::ParseFormula("C6H11NO"), ModificationSites::L)}, {
            {"Methionine", new Residue("Methionine", L'M', "Met",ChemicalFormula::ParseFormula("C5H9NOS"), ModificationSites::M)}, {
            {"Proline", new Residue("Proline", L'P', "Pro",ChemicalFormula::ParseFormula("C5H7NO"), ModificationSites::P)}, {
            {"Serine", new Residue("Serine", L'S', "Ser",ChemicalFormula::ParseFormula("C3H5NO2"), ModificationSites::S)}, {
            {"Tryptophan", new Residue("Tryptophan", L'W', "Trp",ChemicalFormula::ParseFormula("C11H10N2O"), ModificationSites::W)}, {
            {"Valine", new Residue("Valine", L'V', "Val",ChemicalFormula::ParseFormula("C5H9NO"), ModificationSites::V)}
            };
