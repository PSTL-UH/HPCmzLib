...
namespace Proteomics {
    ...
    public:
        ...
        /// </summary>
        static std::vector<Proteomics::Fragment*> GetSiteDeterminingFragments(AminoAcidPolymer *peptideA, AminoAcidPolymer *peptideB, FragmentTypes types);
        ...
        /// <returns></returns>
        std::vector<Proteomics::Fragment*> GetSiteDeterminingFragments(AminoAcidPolymer *other, FragmentTypes type);

        std::vector<Proteomics::Fragment*> Fragment(FragmentTypes types);
        ...
        /// <returns></returns>
        std::vector<Proteomics::Fragment*> Fragment(FragmentTypes types, bool calculateChemicalFormula);

        std::vector<Proteomics::Fragment*> Fragment(FragmentTypes types, int number);

        std::vector<Proteomics::Fragment*> Fragment(FragmentTypes types, int number, bool calculateChemicalFormula);

        std::vector<Proteomics::Fragment*> Fragment(FragmentTypes types, int minIndex, int maxIndex);

        std::vector<Proteomics::Fragment*> Fragment(FragmentTypes types, int minIndex, int maxIndex, bool calculateChemicalFormula);
