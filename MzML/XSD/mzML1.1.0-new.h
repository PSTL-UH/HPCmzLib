...
namespace ms
{
  namespace mzml
  {
    ...
    class OffsetType: public ::xml_schema::type
    {

      //From converted files:
      //---------------------------------------------
      private:
          std::string idRefField;

          std::string spotIDField;
...
//ORIGINAL LINE: [System.Xml.Serialization.XmlTextAttribute()] public long Value
      ...
      // typedef ::xml_schema::string idRefField;
      // typedef ::xml_schema::string spotIDField;
      // typedef ::xml_schema::double_ scanTimeField;
      // typedef ::xml_schema::boolean scanTimeFieldSpecified;
      // typedef ::xml_schema::long_ valueField;
      ...
      // void
      // idRef (::std::unique_ptr< idRefField > p);
      ...
      // void
      // spotID (::std::unique_ptr< spotIDField > p);
      ...
      // void
      // scanTime (::std::unique_ptr< scanTimeField > p);
      // /// <remarks/>
      ...
      // const scanTimeFieldSpecified&
      // scanTimeSpecified () const;

      // scanTimeFieldSpecified&
      // scanTimeSpecified ();
      ...
      // void
      // scanTimeSpecified (::std::unique_ptr< scanTimeFieldSpecified > p);
      ...
      // void
      // value (::std::unique_ptr< valueField > p);


      // //constructors
      // //
      // OffsetType (const idRefField&,
      //             const spotIDField&,
      //             const scanTimeField&,
      //             const scanTimeFieldSpecified&,
      //             const valueField&);
...
//ORIGINAL LINE: [System.Xml.Serialization.XmlAttributeAttribute()] public IndexTypeName name
      ...
      // typedef ::ms::mzml::OffsetType offsetField;
      // typedef ::ms::mzml::IndexTypeName nameField;
      ...
      // void
      // offset (::std::unique_ptr< offsetField > p);
      ...
      // void
      // name (::std::unique_ptr< nameField > p);

      // //constructors
      // //
      // IndexType (const offsetField&,
      //             const nameField&);
    ...
    // enum class IndexTypeName: public ::xml_schema::type
    enum class IndexTypeName
    {
      //No converted files for IndexTypeName
      /// <remarks/>
      spectrum,
...
//ORIGINAL LINE: [System.Xml.Serialization.XmlAttributeAttribute(DataType="nonNegativeInteger")] public string count
      ...
      // typedef ::ms::mzml::IndexType indexField;
      // typedef ::xml_schema::string countField;
      ...
      // void
      // index (::std::unique_ptr< indexField > p);
      ...
      // void
      // count (::std::unique_ptr< countField > p);


      // //constructors
      // //
      // IndexListType (const indexField&,
      //             const countField&);
    ...
    class indexedmzML: public ::xml_schema::type
    {
      ...
      typedef ::ms::mzml::mzMLType mzMLField;
      typedef ::ms::mzml::IndexListType indexListField;
      typedef std::optional<long> indexListOffsetField;
      typedef ::xml_schema::string fileChecksumField;
      ...
      // void
      // mzML (::std::unique_ptr< mzMLField > p);


      // const indexListField&
      // indexList () const;
      ...
      // void
      // indexList (::std::unique_ptr< indexListField > p);


      // const indexListOffsetField&
      // indexListOffset () const;

      // indexListOffsetField&
      // indexListOffset ();
      ...
      // void
      // indexListOffset (::std::unique_ptr< indexListOffsetField > p);


      // const fileChecksumField&
      // fileChecksum () const;
      ...
      // void
      // fileChecksum (::std::unique_ptr< fileChecksumField > p);


      // //constructors
      // //
      // indexedmzML (const mzMLField&,
      //             const indexListField&,
      //             indexListOffsetField&,
      //             fileChecksumField&);
...
namespace ms
{
  namespace mzml
  {
    ...
    void
    operator<< (::xercesc::DOMElement&, const IndexTypeName&);
