...
//NEW METHODS
    ...
    // const indexedmzML::mzMLField& indexedmzML::
    // mzML () const
    // {
    //   return this->mzMLField;
    // }

    // indexedmzML::mzMLField& indexedmzML::
    // mzML ()
    // {
    //   return this->mzMLField;
    // }

    // const indexedmzML::indexListField& indexedmzML::
    // indexList () const
    // {
    //   return this->indexListField;
    // }

    // indexedmzML::indexListField& indexedmzML::
    // indexList ()
    // {
    //   return this->indexListField;
    // }

    // const indexedmzML::indexListOffsetField& indexedmzML::
    // indexListOffset () const
    // {
    //   return this->indexListOffsetField;
    // }

    // indexedmzML::indexListOffsetField& indexedmzML::
    // indexListOffset ()
    // {
    //   return this->indexListOffsetField;
    // }

    // const indexedmzML::fileChecksumField& indexedmzML::
    // fileChecksum () const
    // {
    //   return this->fileChecksumField;
    // }

    // indexedmzML::fileChecksumField& indexedmzML::
    // fileChecksum ()
    // {
    //   return this->fileChecksumField;
    // }
    ...
    // void indexedmzML::
    // mzML (const mzMLField& x)
    // {
    //   this->mzMLField.set (x);
    // }

    // void indexedmzML::
    // mzML (::std::unique_ptr< mzMLField > x)
    // {
    //   this->mzMLField.set (std::move (x));
    // }

    // void indexedmzML::
    // indexList (const indexListField& x)
    // {
    //   this->indexListField.set (x);
    // }

    // void indexedmzML::
    // indexList (::std::unique_ptr< indexListField > x)
    // {
    //   this->indexListField.set (std::move (x));
    // }

    // void indexedmzML::
    // indexListOffset (const indexListOffsetField& x)
    // {
    //   this->indexListOffsetField.set (x);
    // }

    // void indexedmzML::
    // indexListOffset (::std::unique_ptr< indexListOffsetField > x)
    // {
    //   this->indexListOffsetField.set (std::move (x));
    // }

    // void indexedmzML::
    // fileChecksum (const fileChecksumField& x)
    // {
    //   this->fileChecksumField.set (x);
    // }

    // void indexedmzML::
    // fileChecksum (::std::unique_ptr< fileChecksumField > x)
    // {
    //   this->fileChecksumField.set (std::move (x));
    // }


    //from C# mzML1_1_1idx.cs
    //OffsetType
    //from converted files:
    //---------------------------------------
    ...
    // const OffsetType::idRefField& OffsetType::
    // idRef () const
    // {
    //   return this->idRefField;
    // }

    // OffsetType::idRefField& OffsetType::
    // idRef ()
    // {
    //   return this->idRefField;
    // }

    // const OffsetType::spotIDField& OffsetType::
    // spotID () const
    // {
    //   return this->spotIDField;
    // }

    // OffsetType::spotIDField& OffsetType::
    // spotID ()
    // {
    //   return this->spotIDField;
    // }

    // const OffsetType::scanTimeField& OffsetType::
    // scanTime () const
    // {
    //   return this->scanTimeField;
    // }

    // OffsetType::scanTimeField& OffsetType::
    // scanTime ()
    // {
    //   return this->scanTimeField;
    // }

    // const OffsetType::scanTimeFieldSpecified& OffsetType::
    // scanTimeSpecified () const
    // {
    //   return this->scanTimeFieldSpecified;
    // }

    // OffsetType::scanTimeFieldSpecified& OffsetType::
    // scanTimeSpecified ()
    // {
    //   return this->scanTimeFieldSpecified;
    // }

    // const OffsetType::valueField& OffsetType::
    // value () const
    // {
    //   return this->valueField;
    // }

    // OffsetType::valueField& OffsetType::
    // value ()
    // {
    //   return this->valueField;
    // }
    ...
    // void OffsetType::
    // idRef (const idRefField& x)
    // {
    //   this->idRefField.set (x);
    // }

    // void OffsetType::
    // idRef (::std::unique_ptr< idRefField > x)
    // {
    //   this->idRefField.set (std::move (x));
    // }

    // void OffsetType::
    // spotID (const spotIDField& x)
    // {
    //   this->spotIDField.set (x);
    // }

    // void OffsetType::
    // spotID (::std::unique_ptr< spotIDField > x)
    // {
    //   this->spotIDField.set (std::move (x));
    // }

    // void OffsetType::
    // scanTime (const scanTimeField& x)
    // {
    //   this->scanTimeField.set (x);
    // }

    // void OffsetType::
    // scanTime (::std::unique_ptr< scanTimeField > x)
    // {
    //   this->scanTimeField.set (std::move (x));
    // }

    // void OffsetType::
    // scanTimeSpecified (const scanTimeFieldSpecified& x)
    // {
    //   this->scanTimeFieldSpecified.set (x);
    // }

    // void OffsetType::
    // scanTimeSpecified (::std::unique_ptr< scanTimeFieldSpecified > x)
    // {
    //   this->scanTimeFieldSpecified.set (std::move (x));
    // }

    // void OffsetType::
    // value (const valueField& x)
    // {
    //   this->valueField.set (x);
    // }

    // void OffsetType::
    // value (::std::unique_ptr< valueField > x)
    // {
    //   this->valueField.set (std::move (x));
    // }
    ...
    //------------------------------------
    // //IndexType
    // const IndexType::offsetField& IndexType::
    // offset () const
    // {
    //   return this->offsetField;
    // }

    // IndexType::offsetField& IndexType::
    // offset ()
    // {
    //   return this->offsetField;
    // }

    // const IndexType::nameField& IndexType::
    // name () const
    // {
    //   return this->nameField;
    // }

    // IndexType::nameField& IndexType::
    // name ()
    // {
    //   return this->nameField;
    // }
    ...
    // void IndexType::
    // offset (const offsetField& x)
    // {
    //   this->offsetField.set (x);
    // }

    // void IndexType::
    // offset (::std::unique_ptr< offsetField > x)
    // {
    //   this->offsetField.set (std::move (x));
    // }

    // void IndexType::
    // name (const nameField& x)
    // {
    //   this->nameField.set (x);
    // }

    // void IndexType::
    // name (::std::unique_ptr< nameField > x)
    // {
    //   this->nameField.set (std::move (x));
    // }
    ...
    // const IndexListType::indexField& IndexListType::
    // index () const
    // {
    //   return this->indexField;
    // }

    // IndexListType::indexField& IndexListType::
    // index ()
    // {
    //   return this->indexField;
    // }

    // const IndexListType::countField& IndexListType::
    // count () const
    // {
    //   return this->countField;
    // }

    // IndexListType::countField& IndexListType::
    // count ()
    // {
    //   return this->countField;
    // }
    ...
    // void IndexListType::
    // index (const indexField& x)
    // {
    //   this->indexField.set (x);
    // }

    // void IndexListType::
    // index (::std::unique_ptr< indexField > x)
    // {
    //   this->indexField.set (std::move (x));
    // }

    // void IndexListType::
    // count (const countField& x)
    // {
    //   this->countField.set (x);
    // }

    // void IndexListType::
    // count (::std::unique_ptr< countField > x)
    // {
    //   this->countField.set (std::move (x));
    // }
