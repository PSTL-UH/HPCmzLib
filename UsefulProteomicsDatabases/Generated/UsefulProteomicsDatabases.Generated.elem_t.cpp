...
namespace UsefulProteomicsDatabases {
    namespace Generated {
        ...
        std::wstring elem_t::gettitle() const {
            return this->titleField;
        }

        void elem_t::settitle(const std::wstring &value) {
            this->titleField = value;
        }

        std::wstring elem_t::getfull_name() const {
            return this->full_nameField;
        }

        void elem_t::setfull_name(const std::wstring &value) {
