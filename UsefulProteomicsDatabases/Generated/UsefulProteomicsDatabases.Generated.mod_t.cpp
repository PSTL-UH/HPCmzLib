...
namespace UsefulProteomicsDatabases {
    namespace Generated {
        ...
        std::vector<std::wstring> mod_t::getalt_name() const {
            return this->alt_nameField;
        }

        void mod_t::setalt_name(const std::vector<std::wstring> &value) {
        ...
        std::wstring mod_t::getmisc_notes() const {
            return this->misc_notesField;
        }

        void mod_t::setmisc_notes(const std::wstring &value) {
            this->misc_notesField = value;
        }

        std::wstring mod_t::gettitle() const {
            return this->titleField;
        }

        void mod_t::settitle(const std::wstring &value) {
            this->titleField = value;
        }

        std::wstring mod_t::getfull_name() const {
            return this->full_nameField;
        }

        void mod_t::setfull_name(const std::wstring &value) {
            this->full_nameField = value;
        }

        std::wstring mod_t::getusername_of_poster() const {
            return this->username_of_posterField;
        }

        void mod_t::setusername_of_poster(const std::wstring &value) {
            this->username_of_posterField = value;
        }

        std::wstring mod_t::getgroup_of_poster() const {
            return this->group_of_posterField;
        }

        void mod_t::setgroup_of_poster(const std::wstring &value) {
            this->group_of_posterField = value;
        }

        std::wstring mod_t::getdate_time_posted() const {
            return this->date_time_postedField;
        }

        void mod_t::setdate_time_posted(const std::wstring &value) {
            this->date_time_postedField = value;
        }

        std::wstring mod_t::getdate_time_modified() const {
            return this->date_time_modifiedField;
        }

        void mod_t::setdate_time_modified(const std::wstring &value) {
        ...
        std::wstring mod_t::getex_code_name() const {
            return this->ex_code_nameField;
        }

        void mod_t::setex_code_name(const std::wstring &value) {
