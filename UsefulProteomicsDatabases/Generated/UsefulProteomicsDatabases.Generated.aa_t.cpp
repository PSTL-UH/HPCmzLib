...
namespace UsefulProteomicsDatabases
{
    namespace Generated
    {
        ...
        std::string aa_t::gettitle() const
        {
            return this->titleField;
        }

        void aa_t::settitle(const std::string &value)
        {
            this->titleField = value;
        }

        std::string aa_t::getthree_letter() const
        {
            return this->three_letterField;
        }

        void aa_t::setthree_letter(const std::string &value)
        {
            this->three_letterField = value;
        }

        std::string aa_t::getfull_name() const
        {
            return this->full_nameField;
        }

        void aa_t::setfull_name(const std::string &value)
        {
