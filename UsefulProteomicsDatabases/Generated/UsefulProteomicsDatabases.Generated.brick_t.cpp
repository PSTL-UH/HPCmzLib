...
namespace UsefulProteomicsDatabases {
    namespace Generated {
        ...
        std::wstring brick_t::gettitle() const {
            return this->titleField;
        }

        void brick_t::settitle(const std::wstring &value) {
            this->titleField = value;
        }

        std::wstring brick_t::getfull_name() const {
            return this->full_nameField;
        }

        void brick_t::setfull_name(const std::wstring &value) {
