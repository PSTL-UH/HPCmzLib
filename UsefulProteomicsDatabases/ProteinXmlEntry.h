...
=======
    ...
    private:
        ...
        static Regex *const SubstituteWhitespace;
    ...
    private:
        static void ParseAnnotatedMods(std::unordered_map<int, std::vector<Modification*>> &destination, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications, std::vector<(int, std::string)*> &annotatedMods);
