...
namespace UsefulProteomicsDatabases
{
    ...
    private:
	   // First int is the position
	   // Second string is the originalModificationID
        ...
        /// </summary>
    public:
        void ParseElement(const std::string &elementName, xmlTextReaderPtr *xml);

        /// <summary>
        /// Finish parsing at the end of an element
        /// </summary>
        Protein *ParseEndElement(xmlTextReaderPtr *xml, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications, bool isContaminant, const std::string &proteinDbLocation);

        /// <summary>
        /// Finish parsing an entry
        /// </summary>
        Protein *ParseEntryEndElement(xmlTextReaderPtr *xml, bool isContaminant, const std::string &proteinDbLocation, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications);

        /// <summary>
        /// Finish parsing a subfeature element
        /// </summary>
        void ParseSubFeatureEndElement(xmlTextReaderPtr *xml, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications);
    ...
    private:
        ...
        void ParseDatabaseReferenceEndElement(xmlTextReaderPtr *xml);
