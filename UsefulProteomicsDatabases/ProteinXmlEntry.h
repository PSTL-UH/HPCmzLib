...
namespace UsefulProteomicsDatabases
{
	class ProteinXmlEntry
	{
		...
		public:
			...
			void ParseElement(const std::string &elementName, tinyxml2::XMLNode *xml);
			...
			Protein *ParseEndElement(tinyxml2::XMLNode *xml, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications, bool isContaminant, const std::string &proteinDbLocation);
			...
			Protein *ParseEntryEndElement(tinyxml2::XMLNode *xml, bool isContaminant, const std::string &proteinDbLocation, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications);
			...
			void ParseSubFeatureEndElement(tinyxml2::XMLNode *xml, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications);
			...
			void ParseFeatureEndElement(tinyxml2::XMLNode *xml, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications);
		...
		private:
			...
			void ParseDatabaseReferenceEndElement(tinyxml2::XMLNode *xml);
