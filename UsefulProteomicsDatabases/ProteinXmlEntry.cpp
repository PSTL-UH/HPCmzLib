...
<<<<<<< HEAD
	...
	void ProteinXmlEntry::ParseElement(const std::string &elementName, tinyxml2::XMLDocument *xml)
	{
		int outValue;
	...
	Protein *ProteinXmlEntry::ParseEndElement(tinyxml2::XMLDocument *xml, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications, bool isContaminant, const std::string &proteinDbLocation)
	{
	...
	Protein *ProteinXmlEntry::ParseEntryEndElement(tinyxml2::XMLDocument *xml, bool isContaminant, const std::string &proteinDbLocation, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications)
	{
	...
	void ProteinXmlEntry::ParseSubFeatureEndElement(tinyxml2::XMLDocument *xml, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications)
	{
	...
	void ProteinXmlEntry::ParseFeatureEndElement(tinyxml2::XMLDocument *xml, std::vector<std::string> &modTypesToExclude, std::unordered_map<std::string, Modification*> &unknownModifications)
	{
	...
	void ProteinXmlEntry::ParseDatabaseReferenceEndElement(tinyxml2::XMLDocument *xml)
	{
...
>>>>>>> parent of 13dcbdc... Begin working on ProteinXmlEntry conversion from library XmlReader to tinyxml2. Added starter Makefile. Header almost complete.
}
